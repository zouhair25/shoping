 ...
 */
final class Version20191009191453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE password password VARCHAR(150) NOT NULL, CHANGE email email VARCHAR(40) DEFAULT NULL, CHANGE tel tel VARCHAR(20) DEFAULT NULL, CHANGE adress adress VARCHAR(100) DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE password password VARCHAR(40) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE email email VARCHAR(40) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE tel tel VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE adress adress VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE active active TINYINT(1) DEFAULT \'NULL\'');
    }
}
