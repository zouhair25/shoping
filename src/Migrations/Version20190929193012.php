 ...
 */
final class Version20190929193012 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE fabricant_id fabricant_id INT DEFAULT NULL, CHANGE pointure_id pointure_id INT DEFAULT NULL, CHANGE taille_id taille_id INT DEFAULT NULL, CHANGE promotion_id promotion_id INT DEFAULT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE color_id color_id INT DEFAULT NULL, CHANGE nbre_vendu nbre_vendu INT DEFAULT NULL, CHANGE image2 image2 VARCHAR(40) DEFAULT NULL, CHANGE image3 image3 VARCHAR(40) DEFAULT NULL, CHANGE image4 image4 VARCHAR(40) DEFAULT NULL, CHANGE image5 image5 VARCHAR(40) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE fabricant_id fabricant_id INT DEFAULT NULL, CHANGE pointure_id pointure_id INT NOT NULL, CHANGE taille_id taille_id INT DEFAULT NULL, CHANGE promotion_id promotion_id INT DEFAULT NULL, CHANGE categorie_id categorie_id INT NOT NULL, CHANGE color_id color_id INT DEFAULT NULL, CHANGE nbre_vendu nbre_vendu INT DEFAULT NULL, CHANGE image2 image2 VARCHAR(40) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE image3 image3 VARCHAR(40) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE image4 image4 VARCHAR(40) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE image5 image5 VARCHAR(40) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE couleur CHANGE active active TINYINT(1) DEFAULT \'NULL\'');
